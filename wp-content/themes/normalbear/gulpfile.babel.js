...
export const styles = () => {
    return src(['src/scss/**/*.scss'])
        ...
        .pipe(gulpif(!PRODUCTION,replace(/http:\/\/localhost:3000\/sbc-theme-template\//g, 'http://localhost/sbc-theme-template/')))
        .pipe(gulpif(PRODUCTION, replace(/http:\/\/localhost:3000\/sbc-theme-template\//g, '/')))
        .pipe(gulpif(PRODUCTION, replace(/http:\/\/localhost\/sbc-theme-template\//g, '/')))
