    ...
    <section class="footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col col-12 col-sm-5 col-lg-3 footer-nav-cont">
                    <?php if ( is_active_sidebar( 'center-col' ) ) : ?>
                        <?php dynamic_sidebar( 'center-col' ); ?>
                    <?php endif; ?>
                </div>
                <div class="col col-12 col-sm-7 col-lg-3 footer-contact-cont">
                    <h4>Contact</h4>
                    <?php if($phone): ?>
                ...
                <div class="col col-12 col-sm-5 col-lg-2">
                    <h4>Subscribe</h4>
